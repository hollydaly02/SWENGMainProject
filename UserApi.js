...
/*The way this class works is when you run the dev server, open the console on the browser, you put in a start and end date
 * into the input boxes and click fetch data. The functions will begin to fetch all of the data and print them as it iterates on
 * the console. Once it's all finished you can click any of the buttons to get the information from that repo.
 * as useState is used you will have to click the button twice to see the values update. useState is an async function.
 */
function UserApi() {
